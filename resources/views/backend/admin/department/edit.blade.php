<form id='edit' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="needs-validation"
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <input type="text" class="form-control" id="dept_name" name="dept_name" value="{{ $department->dept_name }}"
        ...
        <div class="form-group col-md-3">
            ...
            <input type="radio" name="status" class="flat-green"
                   value="1" {{ ( $department->status == 1 ) ? 'checked' : '' }} /> Active
            <input type="radio" name="status" class="flat-green"
                   value="0" {{ ( $department->status == 0 ) ? 'checked' : '' }}/> In Active
        </div>
        <div class="clearfix"></div>
