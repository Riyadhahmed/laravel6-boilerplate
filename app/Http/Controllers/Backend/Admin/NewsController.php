      ...
      if ($request->ajax()) {
         ...
         return Datatables::of($news)
           ...
           ->addColumn('action', function ($news) use ($can_edit, $can_delete) {
              ...
              $html .= '<a data-toggle="tooltip" ' . $can_edit . '  id="' . $news->id . '" class="btn btn-xs btn-info mr-1 edit" title="Edit"><i class="fa fa-edit"></i> </a>';
              $html .= '<a data-toggle="tooltip" ' . $can_delete . ' id="' . $news->id . '" class="btn btn-xs btn-danger delete" title="Delete"><i class="fa fa-trash"></i> </a>';
              $html .= '</div>';
              return $html;
           })
